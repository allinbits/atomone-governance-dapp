    ...
    <div class="flex flex-row pt-8 md:pt-[72px]">
      ...
      <div class="flex flex-col gap-8 w-3/4">
        ...
        <div class="flex flex-col gap-8">
          ...
          <!-- Chain Description -->
          <p
            class="text-grey-100 text-300 lg:w-[656px] font-normal text-left text-pretty block pb-8 lg:pb-[72px] after:absolute after:block after:left-0 after:w-full after:bg-grey-300 after:h-px after:mt-14"
          >
            {{ $t("homepage.intro") }}
          </p>
        </div>
