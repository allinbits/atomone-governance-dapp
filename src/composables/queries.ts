...
export const useBalanceQuery = (
  ...
  return useQuery<BalanceQuery, BalanceQueryVariables>(
    BalanceDocument,
    variables,
    options ?? {}
  );
...
export const useBlockHeightQuery = (
  ...
  return useQuery<BlockHeightQuery, BlockHeightQueryVariables>(
    BlockHeightDocument,
    variables,
    options ?? {}
  );
...
export const useBlockTimeQuery = (
  ...
  return useQuery<BlockTimeQuery, BlockTimeQueryVariables>(
    BlockTimeDocument,
    variables,
    options ?? {}
  );
...
export const useDelegatedQuery = (
  ...
  return useQuery<DelegatedQuery, DelegatedQueryVariables>(
    DelegatedDocument,
    variables,
    options ?? {}
  );
...
export const useValsetQuery = (
  ...
  return useQuery<ValSetQuery, ValSetQueryVariables>(
    ValSetDocument,
    variables,
    options ?? {}
  );
...
export const useProposalQuery = (
  ...
  return useQuery<ProposalQuery, ProposalQueryVariables>(
    ProposalDocument,
    variables,
    options ?? {}
  );
...
export const useParamsQuery = (options?: UseQueryOptions<ParamsQuery, ParamsQueryVariables>) => {
  return useQuery<ParamsQuery, ParamsQueryVariables>(
    ParamsDocument,
    {},
    options ?? {}
  );
...
export const useVoteHistoryQuery = (
  ...
  return useQuery<VoteHistoryQuery, VoteHistoryQueryVariables>(
    VoteHistoryDocument,
    variables,
    options ?? {}
  );
...
export const useValidatorsQuery = (options?: UseQueryOptions<ValidatorsQuery, ValidatorsQueryVariables>) => {
  return useQuery<ValidatorsQuery, ValidatorsQueryVariables>(
    ValidatorsDocument,
    {},
    options ?? {}
  );
...
export const useVotesQuery = (
  ...
  return useQuery<VotesQuery, VotesQueryVariables>(
    VotesDocument,
    variables,
    options ?? {}
  );
...
export const useAllVotesQuery = (
  ...
  return useQuery<AllVotesQuery, AllVotesQueryVariables>(
    AllVotesDocument,
    variables,
    options ?? {}
  );
...
export const useVoteOptionQuery = (
  ...
  return useQuery<VoteOptionQuery, VoteOptionQueryVariables>(
    VoteOptionDocument,
    variables,
    options ?? {}
  );
...
export const useLazyBalanceQuery = (
  ...
  return useLazyQuery<BalanceQuery, BalanceQueryVariables>(
    BalanceDocument,
    variables,
    options ?? {}
  );
...
export const useLazyBlockHeightQuery = (
  ...
  return useLazyQuery<BlockHeightQuery, BlockHeightQueryVariables>(
    BlockHeightDocument,
    variables,
    options ?? {}
  );
...
export const useLazyBlockTimeQuery = (
  ...
  return useLazyQuery<BlockTimeQuery, BlockTimeQueryVariables>(
    BlockTimeDocument,
    variables,
    options ?? {}
  );
...
export const useLazyDelegatedQuery = (
  ...
  return useLazyQuery<DelegatedQuery, DelegatedQueryVariables>(
    DelegatedDocument,
    variables,
    options ?? {}
  );
...
export const useLazyValsetQuery = (
  ...
  return useLazyQuery<ValSetQuery, ValSetQueryVariables>(
    ValSetDocument,
    variables,
    options ?? {}
  );
...
export const useLazyProposalQuery = (
  ...
  return useLazyQuery<ProposalQuery, ProposalQueryVariables>(
    ProposalDocument,
    variables,
    options ?? {}
  );
...
export const useLazyParamsQuery = (options?: UseQueryOptions<ParamsQuery, ParamsQueryVariables>) => {
  return useLazyQuery<ParamsQuery, ParamsQueryVariables>(
    ParamsDocument,
    {},
    options ?? {}
  );
...
export const useLazyStakingQuery = (options?: UseQueryOptions<StakingQuery, StakingQueryVariables>) => {
  return useLazyQuery<StakingQuery, StakingQueryVariables>(
    StakingDocument,
    {},
    options ?? {}
  );
...
export const useLazyVoteHistoryQuery = (
  ...
  return useLazyQuery<VoteHistoryQuery, VoteHistoryQueryVariables>(
    VoteHistoryDocument,
    variables,
    options ?? {}
  );
...
export const useLazyValidatorsQuery = (options?: UseQueryOptions<ValidatorsQuery, ValidatorsQueryVariables>) => {
  return useLazyQuery<ValidatorsQuery, ValidatorsQueryVariables>(
    ValidatorsDocument,
    {},
    options ?? {}
  );
...
export const useLazyVotesQuery = (
  ...
  return useLazyQuery<VotesQuery, VotesQueryVariables>(
    VotesDocument,
    variables,
    options ?? {}
  );
...
export const useLazyAllVotesQuery = (
  ...
  return useLazyQuery<AllVotesQuery, AllVotesQueryVariables>(
    AllVotesDocument,
    variables,
    options ?? {}
  );
...
export const useLazyVoteOptionQuery = (
  ...
  return useLazyQuery<VoteOptionQuery, VoteOptionQueryVariables>(
    VoteOptionDocument,
    variables,
    options ?? {}
  );
